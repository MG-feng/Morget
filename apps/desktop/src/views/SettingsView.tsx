  ...
  return (
    <div>
      ...
      <div className="card settings-group">
        ...
        <div className="setting-row"><div className="setting-label"><span>{Lang.get('settings.graphics.fps')}</span><small>{settings.fps === 0 ? Lang.get('settings.graphics.fps.unlimited') : `${settings.fps} FPS`}</small></div><input type="range" min="0" max="300" step="10" value={settings.fps} onChange={e => update('fps', parseInt(e.target.value))} disabled={settings.vsync} /></div>
